    ...
    >
      ...
      <div className="w-full flex justify-between items-start z-10">
        <div>
          ...
          <p className="text-3xl text-[#8b6f47] italic">Rituale del Caffè • {formatDate(brew.created_at)}</p>
        </div>
      ...
      <div className="w-full bg-[#2d2520]/90 backdrop-blur-xl border-2 border-[#d4a574]/40 rounded-[3rem] p-16 z-10 shadow-2xl relative min-h-[900px] flex flex-col justify-between">
        ...
        <div className="grid grid-cols-2 gap-16 mb-16">
          <div className="flex items-center gap-8">
            ...
            <div>
              <p className="text-2xl text-[#8b6f47] mb-2">Coffee / Water</p>
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <p className="text-2xl text-[#8b6f47] mb-2">Brew Time</p>
          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <p className="text-2xl text-[#8b6f47] mb-2">Extraction Ratio</p>
        ...
        {brew.ai_recap && (
          <div className="bg-[#1a1410] p-12 rounded-[2.5rem] border-l-[12px] border-[#d4a574] italic shadow-inner mt-8">
            ...
            <p className="text-right text-[#8b6f47] mt-8 text-3xl">— Brew Master AI</p>
          </div>
        )}
      </div>
